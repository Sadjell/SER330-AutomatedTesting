...
class TestCourseOffering(unittest.TestCase):
    ...
    def test_VerifyGradeSubmission_WhenGradeConditionIsNotMet_ReturnsNoGrade_UnitTest(self):
    ...
    def test_VerifyGradeSubmission_WhenMoreThanOneGradeIsSubmitted_Returns_UnitTest(self):
    ...
    def test_VerifyGradeSubmission_WhenNameConditionIsNotMet_ReturnsNoGrade_UnitTest(self):
